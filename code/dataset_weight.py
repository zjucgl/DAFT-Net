...
class MyWeightDataset(Dataset):
    def __init__(self, data):
        self.data = data
        # 记录 context_input 的索引
        ...
        for i, col in enumerate(self.data.columns):
            ...
            # 记录 context_input 的索引
            if col in ["age", "is_smoking","is_family_history",
                       "is_diabetes", 'diastolic_pressure','body_mass_index',
    ...
    def __getitem__(self, idx):
        ...
        # 提取 context_input（age, is_smoking, is_diabetes）
        context_input = self.data.iloc[idx, self.context_indices].values.astype(np.float32)
        ...
        return basic_data, blood_data, text_data_encoded,raw_data,basic_risk_data_encoded,blood_risk_data_encoded,context_input,labels
